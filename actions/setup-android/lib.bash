...
setup_android_main() {
	...
	[[ -n ${android_ndk_version+x} ]] || variable_not_set android_ndk_version
	[[ -n ${android_build_tools_version+x} ]] || variable_not_set android_build_tools_version
	[[ -n ${android_platform_version+x} ]] || variable_not_set android_platform_version
	(
